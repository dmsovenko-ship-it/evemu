...
- **БАГ: у импульсных лазеров (Pulse Laser) нет эффекта** — юзер заметил после последней сборки. Турет модель/эффект не показывается у ботов с лазером. Приоритет: разобраться с эффектом оружия для лазерных кораблей.
