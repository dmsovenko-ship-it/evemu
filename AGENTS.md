...
- **Осталось проверить после пересборки на `dda2b6de`**: дроны-повстанцы видны/красные и бьют с лучами/цифрами; 20 бомберов у Nyx (не 26/35); агрессия при PvP и атаке челоботом (флаги с обеих сторон); боты не застревают при уходе; сервер не виснет от логов.
