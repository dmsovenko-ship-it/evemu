...
- Крупные системы (не реализованы): FW Plex capture, ship clone bay (AcceptShipInstallation — stub), PI (заглушки), Memory Mgmt/RefPtr→shared_ptr (~400 файлов), PyRep leak-фиксы. Джамп-драйвы/бриджи — РЕШЕНО `6dd25d3d` (валидация активного цино + миграция топлива по расам).
