...
PyResult MissionMgrService::GetMyCourierMissions(PyCallArgs& call)
{
    ...
    if (!sDatabase.RunQuery(res,
        ...
        "  o.rewardISK,"
        "  o.rewardLP,"
        "  CASE WHEN o.originID BETWEEN 60000000 AND 60999999 THEN o.originID ELSE (SELECT agt.locationID FROM agtAgents AS agt WHERE agt.agentID = o.agentID) END AS originID,"
        ...
        "  CASE WHEN o.destinationID BETWEEN 60000000 AND 60999999 THEN o.destinationID ELSE (SELECT agt.locationID FROM agtAgents AS agt WHERE agt.agentID = o.agentID) END AS destinationID,"
