...
public:
    ...
    int32 GetReaction() const                           { return reaction; }
    void SetReaction(int32 react)                       { reaction = react; }
...
private:
    bool active;
    int32 itemID;
    int32 reaction;     // reactionTypeID (invTypeReactions) selected for this module
