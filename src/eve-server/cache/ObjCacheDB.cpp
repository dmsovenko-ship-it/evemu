...
PyRep *ObjCacheDB::Generate_invTypes()
{
    ...
    const char *q = "SELECT typeID, "
        "CASE "
        "  WHEN groupID IN (297,550,551,552,553,554,555,556,557,558,560,561,562,563,565,566,567,568,570,571,572,573,575,576,577,578,579,580,581,582,583,584,755,756,757,758,759,760,761,959,960,961,982,983,984,985,986,987) "
        "  THEN "
        "    CASE "
        "      WHEN groupID IN (550,557,562,567,572,759,961,986,987) THEN 25 "
        "      WHEN groupID IN (551,555,561,566,571,757,960,984,985) THEN 26 "
        "      WHEN groupID IN (552,556,560,565,570,756,959,982,983) THEN 27 "
