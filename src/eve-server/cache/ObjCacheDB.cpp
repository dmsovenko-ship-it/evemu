...
PyRep *ObjCacheDB::Generate_invTypes()
{
    ...
    const char *q = "SELECT typeID, "
        "CASE "
        "  WHEN t.groupID IN (297,298,550,551,552,553,554,555,556,557,558,559,560,561,562,563,564,565,566,567,568,569,570,571,572,573,574,575,576,577,578,579,580,581,582,583,584,593,594,595,596,597,602,603,604,605,606,611,612,613,614,615,620,621,622,623,624,629,630,631,632,633,755,756,757,758,759,760,761,789,790,791,792,793,794,795,796,797,798,799,800,801,802,803,804,805,806,807,808,809,810,811,812,813,814,843,844,845,846,847,848,849,850,851,852,959,960,961,982,983,984,985,986,987,1051,1052,1053,1054,1056) "
        "  THEN "
        "    CASE "
        "      WHEN t.groupID IN (550,557,562,567,572,759,961,986,987,553,559,564,569,574,597,606,615,624,633,805,789,792,800,810,814,847,1053) THEN 25 "
        "      WHEN t.groupID IN (551,555,561,566,571,757,960,984,985,595,604,613,622,631,803,790,791,798,808,812,845,1054) THEN 26 "
        "      WHEN t.groupID IN (552,556,560,565,570,756,959,982,983,594,603,612,621,630,802,848,849,850,851,852,844,1052,1056) THEN 27 "
        "      WHEN t.groupID IN (576,578,580,582,584,755,761,593,602,611,620,629,801,806,793,795,797,807,811,843) THEN 419 "
        "      WHEN t.groupID IN (575,579,581,583,577,758,596,605,614,623,632,804,794,796,799,809,813,846) THEN 420 "
        "      WHEN t.groupID IN (297,298,554,558,563,568,573,760,1051) THEN 28 "
        "      ELSE t.groupID "
        "    END "
        "  ELSE t.groupID "
        "END as groupID, "
