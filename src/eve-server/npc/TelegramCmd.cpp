...
bool IsForbiddenContent(const std::string& lower)
{
    ...
    static const std::string words[] = {
        ...
        "выведу", "в реал", "иски", "продам титан", "куплю титан",
        "куплю кара", "продам кара", "куплю кар", "продам кар", "кара за",
        "пром перса", "пром чара", "продам перса", "куплю перса",
        "продам чара", "куплю чара",
