...
PyObject *CorporationDB::GetCorporation(uint32 corpID) {
    ...
    if (!sDatabase.RunQuery(res,
        ...
        "   COALESCE(w.division1,'1st division') AS division1,"
        "   COALESCE(w.division2,'2nd division') AS division2,"
        "   COALESCE(w.division3,'3rd division') AS division3,"
        "   COALESCE(w.division4,'4th division') AS division4,"
        "   COALESCE(w.division5,'5th division') AS division5,"
        "   COALESCE(w.division6,'6th division') AS division6,"
        "   COALESCE(w.division7,'7th division') AS division7,"
        "   COALESCE(w.walletDivision1,'1st wallet division') AS walletDivision1,"
        "   COALESCE(w.walletDivision2,'2nd wallet division') AS walletDivision2,"
        "   COALESCE(w.walletDivision3,'3rd wallet division') AS walletDivision3,"
        "   COALESCE(w.walletDivision4,'4th wallet division') AS walletDivision4,"
        "   COALESCE(w.walletDivision5,'5th wallet division') AS walletDivision5,"
        "   COALESCE(w.walletDivision6,'6th wallet division') AS walletDivision6,"
        "   COALESCE(w.walletDivision7,'7th wallet division') AS walletDivision7"
