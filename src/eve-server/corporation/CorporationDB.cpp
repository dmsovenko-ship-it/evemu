...
PyObject *CorporationDB::GetCorporation(uint32 corpID) {
    ...
    if (!sDatabase.RunQuery(res,
        ...
        "   COALESCE(w.division1,'1st division'),COALESCE(w.division2,'2nd division'),"
        "   COALESCE(w.division3,'3rd division'),COALESCE(w.division4,'4th division'),"
        "   COALESCE(w.division5,'5th division'),COALESCE(w.division6,'6th division'),"
        "   COALESCE(w.division7,'7th division'),"
        "   COALESCE(w.walletDivision1,'1st wallet division'),COALESCE(w.walletDivision2,'2nd wallet division'),"
        "   COALESCE(w.walletDivision3,'3rd wallet division'),COALESCE(w.walletDivision4,'4th wallet division'),"
        "   COALESCE(w.walletDivision5,'5th wallet division'),COALESCE(w.walletDivision6,'6th wallet division'),"
        "   COALESCE(w.walletDivision7,'7th wallet division')"
