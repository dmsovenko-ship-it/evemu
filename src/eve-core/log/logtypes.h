...
LOG_TYPE( CLIENT, DEBUG, DISABLED, "ClientDebug" )
...
LOG_CATEGORY( EXPEDITION )
LOG_TYPE( EXPEDITION, ERROR, ENABLED, "Exp Error" )
LOG_TYPE( EXPEDITION, MESSAGE, DISABLED, "Exp Msg" )
...
LOG_CATEGORY( BOT )
LOG_TYPE( BOT, ERROR,   ENABLED, "Bot Error" )
LOG_TYPE( BOT, WARNING, DISABLED, "Bot Warning" )
LOG_TYPE( BOT, MESSAGE, DISABLED, "Bot Msg" )
LOG_TYPE( BOT, INFO, DISABLED, "Bot Info" )
LOG_TYPE( BOT, TRACE, DISABLED, "Bot Trace" )
LOG_TYPE( BOT, AI_TRACE, DISABLED, "Bot AI Trace" )
