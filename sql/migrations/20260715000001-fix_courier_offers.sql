-- Fix stale courier/trade mission offers with zero/system destination/origin IDs
-- Fixes cases where agt.locationID is a solarSystemID or staStations data missing
-- +migrate Up
