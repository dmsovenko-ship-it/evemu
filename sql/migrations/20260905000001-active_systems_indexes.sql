...
-- +migrate Up
ALTER TABLE `chrCharacters` ADD INDEX IF NOT EXISTS `idx_solarsystem` (`solarSystemID`);
ALTER TABLE `entity` ADD INDEX IF NOT EXISTS `idx_location_flag` (`locationID`, `flag`);
