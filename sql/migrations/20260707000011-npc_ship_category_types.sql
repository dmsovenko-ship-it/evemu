...
-- Belt rats show crosshairs on current build; incursion NPCs need same treatment.
-- +migrate Up
...
SELECT 37000, attributeID, valueInt, valueFloat FROM dgmTypeAttributes WHERE typeID = 10025;
INSERT IGNORE INTO dgmTypeAttributes (typeID, attributeID, valueInt, valueFloat)
SELECT 37001, attributeID, valueInt, valueFloat FROM dgmTypeAttributes WHERE typeID = 10030;
INSERT IGNORE INTO dgmTypeAttributes (typeID, attributeID, valueInt, valueFloat)
SELECT 37002, attributeID, valueInt, valueFloat FROM dgmTypeAttributes WHERE typeID = 11913;
INSERT IGNORE INTO dgmTypeAttributes (typeID, attributeID, valueInt, valueFloat)
SELECT 37003, attributeID, valueInt, valueFloat FROM dgmTypeAttributes WHERE typeID = 23383;

-- Copy dogma effects from SDE Entity types to Ship clones
INSERT IGNORE INTO dgmTypeEffects (typeID, effectID, isDefault)
SELECT 37000, effectID, isDefault FROM dgmTypeEffects WHERE typeID = 10025;
INSERT IGNORE INTO dgmTypeEffects (typeID, effectID, isDefault)
SELECT 37001, effectID, isDefault FROM dgmTypeEffects WHERE typeID = 10030;
INSERT IGNORE INTO dgmTypeEffects (typeID, effectID, isDefault)
SELECT 37002, effectID, isDefault FROM dgmTypeEffects WHERE typeID = 11913;
INSERT IGNORE INTO dgmTypeEffects (typeID, effectID, isDefault)
SELECT 37003, effectID, isDefault FROM dgmTypeEffects WHERE typeID = 23383;

-- +migrate Down
DELETE FROM dgmTypeEffects WHERE typeID IN (37000, 37001, 37002, 37003);
DELETE FROM dgmTypeAttributes WHERE typeID IN (37000, 37001, 37002, 37003);
DELETE FROM invTypes WHERE typeID IN (37000, 37001, 37002, 37003);
